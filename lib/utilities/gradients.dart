...
class Gradients {
  Color getGradient1(int condition, String dt) {
    // switch (condition) {
    //   case 200:
    ...
    //   case 800:
    //     if (dt == '01d') {
    //       return Color(0xFFFF1694D);
    //     } else if (dt == '01n') {
    //       return Color(0xFFF8F8F8F);
    //     }
    //     break;
    //   case 801:
    //     if (dt == '02d') {
    ...
    //     return WeatherIcons.alien;
    //}
    // return Color(0xFFFF9C769);
    return Colors.white;
  }

  Color getGradient2(int condition, String dt) {
    // switch (condition) {
    //   case 200:
    //     return WeatherIcons.thunderstorm;
    //     break;
